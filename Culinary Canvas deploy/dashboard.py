...
# from secret_key import API_KEY as api_key  # Removed import of API_KEY from file
...
def initialize_session_state(api_key):
...
def main():
    ...
    if not initialize_session_state(api_key):
        return
